...
print("Which difficulty would you like to play?\n1. Easy-Travel 150 miles, Geese start 40m. back")
difficulty=int(input("2. Regular-Travel 200 miles, Geese start 20m. back\n3. Hard-Travel 250 miles, Geese start 15m. back\n"))
if difficulty==1:
    print("You've selected easy.")
    instructions=input("Would you like instructions? Y or N?")
    if instructions.lower()== "y":
        print("The goal of this game is to lead your duck friend 150 miles to get grapes.")
    ...
    while not done:
        if goose_distance<miles_traveled:
            ...
            if duck_tiredness<8:
                ...
                if oasis==7:
                    print("You have found a bird fountain\nYou refilled your hydro flask and your duck friend rested.")
                    hydro_flask=6
                    duck_tiredness = 0
    ...
    print("You've selected regular.")
    instructions = input("Would you like instructions? Y or N?")
    if instructions.lower() == "y":
        print("The goal of this game is to lead your duck friend 200 miles to get grapes.")
        print("You will be chased by geese, they will start 20 miles behind you\nso take your time and hurry up.")
        print("Every so often you will be asked to make a choice, your choices will determine how well you do")
        print("Your commands include:")
        print("1. Drink some water from your hydro flask\n2. Walk towards the store\n3. Run towards the store")
        print("4. Stop for the night\n5. Check your status\n6. Quit")
        print("You'll start with 6 drinks in your hydro flask and the geese will be behind you by 20 miles.")
        print("Make sure to answer with the # of the command.")
        print()
    else:
        print("Alrighty then")
            ...
            if duck_tiredness < 8:
                ...
                if miles_traveled < 200:
                    ...
                    user_choice = int(input(
                        "1. Drink some water from your hydro flask\n2. Walk towards the store\n3. Run towards the store\n4. Stop for the night\n5. Check your status\n6. Quit\n"))
                    if user_choice == 6:
                        done = True
                    elif user_choice == 1:
                        if hydro_flask >= 1:
    ...
    instructions = input("Would you like instructions? Y or N?")
    if instructions.lower() == "y":
        print("The goal of this game is to lead your duck friend 250 miles to get grapes.")
        print("You will be chased by a group of geese so take your time and hurry up.")
        print("Every so often you will be asked to make a choice, your choices will determine how well you do")
        print("Your commands include:")
        print("1. Drink some water from your hydro flask\n2. Walk towards the store\n3. Run towards the store")
        print("4. Stop for the night\n5. Check your status\n6. Quit")
        print("You'll start with 6 drinks in your hydro flask and the geese will be behind you by 15 miles.")
        print("Make sure to answer with the # of the command.")
        print()
    else:
        print("Alrighty then")
